...
const AdminLogin: React.FC = () => {
  ...
  // Redirection simple si authentifié
  if (state.isAuthenticated) {
    return <Navigate to="/admin/dashboard" replace />;
  }

  // Loading simple pour l'initialisation
  if (state.isLoading) {
    return (
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // La redirection se fera automatiquement via le state.isAuthenticated
      } else {
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-blue-100 overflow-hidden transform hover:shadow-blue-300/50 transition-all duration-500">
          <div className="p-10">
            ...
            {loginError && (
              <div className="mb-6 p-4 bg-red-50 border-2 border-red-300 rounded-xl flex items-start space-x-3 animate-fade-in">
                ...
                <div className="flex-1">
                  <p className="text-red-800 font-semibold text-sm">{loginError}</p>
