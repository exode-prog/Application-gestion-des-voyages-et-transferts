...
// Fonction pour obtenir le profil utilisateur (GET PROFILE)
const getProfile = async (req, res) => {
  try {
    // L'utilisateur est déjà disponible via le middleware auth dans req.user
...
const creerUtilisateur = async (req, res) => {
  try {
    const { username, email, password, role = 'superviseur' } = req.body;
